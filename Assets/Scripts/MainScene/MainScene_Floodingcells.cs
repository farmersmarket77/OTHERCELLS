...
public class MainScene_Floodingcells : MonoBehaviour
{
    ...
    private const int MAX_FLOODING_CELLS = 10;
    ...
    private void MoveFloddingCell()
    {
        for (int i = 0; i < MAX_FLOODING_CELLS; i++)
        {
            flooding_cells_list[i].transform.Translate(new Vector2(1, 1) * Time.deltaTime * 1f);
        }
    }
